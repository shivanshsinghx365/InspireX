...
function addnewquery(){
	...
	// Step 3: Configure the properties and content for the new elements
	newChildElement1.className = 'rounded-3xl p-3 bg-[#2a2e30] text-sm mx-2 my-3 relative';
...
function addnewres(){
	...
	// Step 2: Create new child elements
	const newChildElement1 = document.createElement('div');
	newChildElement1.className = 'rounded-3xl p-3 bg-[#141618] text-sm mx-2 my-3 relative';
